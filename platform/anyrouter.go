...
// AnyRouterAdapter: same as new-api but checkin falls back to /api/user/sign_in
// and also implements full cookie session retry.
type AnyRouterAdapter struct {
	BaseAdapter
}

func init() {
	Register(&AnyRouterAdapter{BaseAdapter: BaseAdapter{Name: "anyrouter"}})
}

func (a *AnyRouterAdapter) Checkin(baseURL, accessToken string, platformUserID int64, opt *RequestOption) (*CheckinResult, error) {
...
func (a *AnyRouterAdapter) GetBalance(baseURL, accessToken string, platformUserID int64, opt *RequestOption) (*BalanceInfo, error) {
...
func (a *AnyRouterAdapter) GetApiTokens(baseURL, accessToken string, platformUserID int64, opt *RequestOption) ([]ApiTokenInfo, error) {
...
func (a *AnyRouterAdapter) GetModels(baseURL, accessToken string, platformUserID int64, opt *RequestOption) ([]string, error) {
...
func (a *AnyRouterAdapter) VerifyToken(baseURL, accessToken string, platformUserID int64, opt *RequestOption) (*VerifyTokenResult, error) {
